...
################################################################################
## Form generated from reading UI file 'pantalla_busuqeda_producto_trabajoduPJfO.ui'
##
...
"}")
        ...
        self.horizontalLayout.addWidget(self.cantidad_producto_trabajo)

        self.cantidad_producto_trabajo_2 = QPushButton(Dialog)
        self.cantidad_producto_trabajo_2.setObjectName(u"cantidad_producto_trabajo_2")
        self.cantidad_producto_trabajo_2.setMinimumSize(QSize(50, 0))
        self.cantidad_producto_trabajo_2.setMaximumSize(QSize(500, 50))
        self.cantidad_producto_trabajo_2.setStyleSheet(u"QPushButton{\n"
"border: 1px solid rgb(0, 0, 0);\n"
"border-radius:15px;\n"
"font:75 12pt;\n"
"}\n"
...
"}")
        ...
        self.horizontalLayout.addWidget(self.cantidad_producto_trabajo_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cantidad_producto_trabajo_2.setText(QCoreApplication.translate("Dialog", u"Cancelar", None))
    # retranslateUi
